...
export const userSettings = pgTable(
  "user_settings",
  {
    ...
    defaultEmailHeadlineTemplate: text("default_email_headline_template"),
    ...
    slowResponseEmailHeadlineTemplate: text("slow_response_email_headline_template"),
    ...
    recoveryEmailHeadlineTemplate: text("recovery_email_headline_template"),
    ...
    prolongedDowntimeEmailHeadlineTemplate: text("prolonged_downtime_email_headline_template"),
    ...
    sslExpiryEmailSubjectTemplate: text("ssl_expiry_email_subject_template"),
    sslExpiryEmailHeadlineTemplate: text("ssl_expiry_email_headline_template"),
    sslExpiryEmailBodyTemplate: text("ssl_expiry_email_body_template"),
    sslExpiryTelegramTemplate: text("ssl_expiry_telegram_template"),
...
export const workspaceSettings = pgTable("workspace_settings", {
  workspaceId: text("workspace_id")
    .primaryKey()
    .references(() => workspaces.id, { onDelete: "cascade" }),
  valuesJson: jsonb("values_json").$type<Record<string, unknown>>().default({}).notNull(),
  createdAt: timestamp("created_at", { withTimezone: true }).defaultNow().notNull(),
  updatedAt: timestamp("updated_at", { withTimezone: true }).defaultNow().notNull(),
});
...
export const companies = pgTable(
  ...
  (table) => [
    ...
    uniqueIndex("companies_workspace_normalized_name_unique").on(
      table.workspaceId,
...
export const publicStatusPages = pgTable(
  ...
  (table) => [
    ...
    uniqueIndex("public_status_pages_workspace_company_unique")
      .on(table.workspaceId, table.companyId)
      .where(sql`${table.companyId} is not null`),
    uniqueIndex("public_status_pages_workspace_default_unique")
...
export const monitors = pgTable("monitors", {
  ...
  emailHeadline: text("email_headline"),
  emailBody: text("email_body"),
  slowResponseEmailSubject: text("slow_response_email_subject"),
  slowResponseEmailHeadline: text("slow_response_email_headline"),
  slowResponseEmailBody: text("slow_response_email_body"),
  slowResponseTelegramTemplate: text("slow_response_telegram_template"),
  recoveryEmailSubject: text("recovery_email_subject"),
  recoveryEmailHeadline: text("recovery_email_headline"),
  recoveryEmailBody: text("recovery_email_body"),
  recoveryTelegramTemplate: text("recovery_telegram_template"),
  prolongedDowntimeEmailSubject: text("prolonged_downtime_email_subject"),
  prolongedDowntimeEmailHeadline: text("prolonged_downtime_email_headline"),
  prolongedDowntimeEmailBody: text("prolonged_downtime_email_body"),
  prolongedDowntimeTelegramTemplate: text("prolonged_downtime_telegram_template"),
  sslExpiryEmailSubject: text("ssl_expiry_email_subject"),
  sslExpiryEmailHeadline: text("ssl_expiry_email_headline"),
  sslExpiryEmailBody: text("ssl_expiry_email_body"),
  sslExpiryTelegramTemplate: text("ssl_expiry_telegram_template"),
...
export const webhookEndpoints = pgTable(
  ...
  (table) => [
    uniqueIndex("webhook_endpoints_workspace_id_unique").on(table.workspaceId),
