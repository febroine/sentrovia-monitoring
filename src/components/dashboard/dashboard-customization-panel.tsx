...
import { ArrowDown, ArrowUp, Eye, EyeOff, Save, X } from "lucide-react";
      ...
      <CardHeader className="flex-row items-start justify-between gap-4 space-y-0">
        <div>
          ...
          <p className="mt-1 text-sm text-muted-foreground">
            Choose the workspace view that matches your daily operations.
          </p>
        </div>
        ...
        <div className="space-y-2">
          ...
          <div className="space-y-2">
            {DASHBOARD_WIDGET_IDS.filter((widget) => isAdmin || widget !== "system").map((widget) => {
              ...
              return (
                <div key={widget} className="flex items-center gap-2 rounded-lg border border-border/70 bg-background/70 px-3 py-2">
