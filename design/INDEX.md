...
Register canonical sources once using real local Markdown links here or `design_sources`
in config. Existing root DESIGN.md, PRODUCT_DESIGN.md and PRODUCT.md are included
automatically when present. `artifact_paths` remains
