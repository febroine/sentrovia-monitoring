...
export function getAuthSecret() {
  return readString(process.env.AUTH_SECRET, DEFAULT_AUTH_SECRET);
}

export function getAppEncryptionSecret() {
  return readString(process.env.APP_ENCRYPTION_SECRET, getAuthSecret() || DEFAULT_APP_ENCRYPTION_SECRET);
}
