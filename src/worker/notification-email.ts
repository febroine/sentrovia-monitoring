...
const TONES = {
  critical: { accent: "#dc2626", soft: "#fef2f2", text: "#991b1b" },
  healthy: { accent: "#059669", soft: "#ecfdf5", text: "#065f46" },
  warning: { accent: "#d97706", soft: "#fffbeb", text: "#92400e" },
} as const;
...
<body style="margin:0;background:#f1f5f9;color:#0f172a;font-family:Arial,Helvetica,sans-serif;">
  ...
  <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="background:#f1f5f9;">
    <tr><td align="center" style="padding:32px 12px;">
      <table role="presentation" width="600" cellspacing="0" cellpadding="0" border="0" style="width:100%;max-width:600px;background:#ffffff;border:1px solid #dbe3ec;border-top:4px solid ${tone.accent};">
        <tr><td style="padding:24px 28px 18px;">
          <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0">
            <tr>
              ...
              <td align="right"><span style="display:inline-block;padding:5px 9px;background:${tone.soft};color:${tone.text};font-size:12px;font-weight:700;line-height:1;">${escapeHtml(input.eventState)}</span></td>
            </tr>
          </table>
          <h1 style="margin:20px 0 5px;font-size:24px;line-height:1.25;color:#0f172a;">${escapeHtml(input.monitorName)}</h1>
        ...
        <tr><td style="border-top:1px solid #e2e8f0;padding:24px 28px;">
          ${content}
        </td></tr>
        <tr><td style="border-top:1px solid #e2e8f0;background:#f8fafc;padding:16px 28px;font-size:12px;line-height:1.5;color:#64748b;">
...
function renderSummary(
  ...
  return `<table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="border-collapse:collapse;background:#f8fafc;border:1px solid #e2e8f0;">
