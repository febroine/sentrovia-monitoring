...
const settingsObjectSchema = z.object({
  ...
  notifications: z.object({
    ...
    defaultEmailHeadlineTemplate: optionalString(500),
    ...
    slowResponseEmailHeadlineTemplate: optionalString(500),
    ...
    recoveryEmailHeadlineTemplate: optionalString(500),
    ...
    prolongedDowntimeEmailHeadlineTemplate: optionalString(500),
    prolongedDowntimeEmailBodyTemplate: optionalString(4000),
    prolongedDowntimeTelegramTemplate: optionalString(4000),
    sslExpiryEmailSubjectTemplate: optionalString(500),
    sslExpiryEmailHeadlineTemplate: optionalString(500),
    sslExpiryEmailBodyTemplate: optionalString(4000),
  ...
  data: z.object({
    ...
    backupWindow: z.string().regex(/^([01]\d|2[0-3]):[0-5]\d$/, "Backup time must use HH:mm format."),
    backupRetentionCount: z.coerce.number().int().min(2).max(90).default(7),
    lastBackupStatus: z.enum(["completed", "failed", "running"]).nullable().default(null),
    lastBackupError: z.string().max(500).nullable().default(null),
    lastAutomaticBackupAt: z.string().datetime().nullable().default(null),
